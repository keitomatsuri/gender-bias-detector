"""
Reference
https://github.com/auth0-developer-hub/api_fastapi_python_hello-world/blob/main/application/dependencies.py
"""
from app.auth.authorization_header_elements import get_bearer_token
from app.auth.custom_exceptions import PermissionDeniedException
